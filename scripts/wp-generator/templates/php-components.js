 ...
 *
 * CSS is loaded from: assets/css/${this.config.themePrefix || 'ds'}-design-system-[hash].css
...
🚨 SIN FALLBACKS: Solo parameters explícitos soportados`);
  ...
  convertLitTemplateToPhp(litTemplate, componentName) {
    console.log(`🔄 Converting ${componentName} using Babel AST...`);
    ...
    try {
      ...
      throw new Error(`❌ AST CONVERSION FAILED for ${componentName}: ${error.message}\n\n🔧 SOLUTION: Check component syntax and template structure`);
    }
  }
